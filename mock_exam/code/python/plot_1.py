...
def _plot(D):
    data_path = f"build/m1_data_{D}d/"
    ...
    if D==1:
        ...
        ax1.set_xlabel("Steps")
        ax1.set_ylabel("Energy")
        saveFig(fig_id="energy_2d_plot", destination="build/m1_data_2d/")
        
        fig2, ax2 = plt.subplots()
        plot2 = ax2.pcolormesh(x, y, fieldx, cmap=CMAP)
        ax2.set_xlabel("x")
        ax2.set_ylabel("y")
        fig2.colorbar(plot2)
        saveFig(fig_id="fieldx_2d_plot", destination="build/m1_data_2d/")
        
        fig3, ax3 = plt.subplots()
        plot3 = ax3.pcolormesh(x, y, fieldy, cmap=CMAP)
        ax3.set_xlabel("x")
        ax3.set_ylabel("y")
        fig3.colorbar(plot3)
        saveFig(fig_id="fieldy_2d_plot", destination="build/m1_data_2d/")
        
        fig4, ax4 = plt.subplots()
        plot4 = ax4.pcolormesh(x, y, potential, cmap=CMAP)
        ax4.set_xlabel("x")
        ax4.set_ylabel("y")
        fig4.colorbar(plot4)
        saveFig(fig_id="potential_2d_plot", destination="build/m1_data_2d/")
        
        fig5, ax5 = plt.subplots()
        plot5 = ax5.pcolormesh(x, y, source, cmap=CMAP)
        ax5.set_xlabel("x")
        ax5.set_ylabel("y")
        fig5.colorbar(plot5)
        saveFig(fig_id="source_2d_plot", destination="build/m1_data_2d/")
        
        fig6, ax6 = plt.subplots()
        x = np.linspace(-4, 4, 49)
        y = np.linspace(-4, 4, 49)
        ...
        saveFig(fig_id="field_streamplot", destination="build/m1_data_2d/")
