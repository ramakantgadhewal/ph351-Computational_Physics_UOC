...
def plot():
    ...
    ax2.set_xlabel('x')
    ax2.set_ylabel('V')
    saveFig(fig_id='Potenial.png', destination="data/")
    ...
    saveFig(fig_id='Initial_wavefunction.png', destination="data/")
    ...
    saveFig(fig_id='mean_value_x.png', destination="data/")
    ...
    saveFig(fig_id='uncertainty_of_x.png', destination="data/")
